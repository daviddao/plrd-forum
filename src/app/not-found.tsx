    ...
    <div className="mx-auto mt-12 max-w-[560px]">
      <div className="lw-card px-8 py-10">
        ...
        <p className="pb-6 text-[14px] text-text-dim3">
          There is no page at this address. Nothing was deleted here — the path
          simply does not exist. Try one of the real pages below:
        </p>
        <ul className="list-disc pl-6 text-[14.5px] leading-[1.9]">
          ...
          <li>
            ...
            — developer &amp; agent resources (API, OpenAPI, MCP)
          </li>
        </ul>
      </div>
    </div>

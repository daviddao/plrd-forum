...
import { SITE_NAME, SITE_ORG_NAME } from "@/lib/site";

export const metadata = {
  title: "About",
  description: `What ${SITE_NAME} is: a research discussion space built on ATProto, where every post, comment, vote, and reaction is a record in the author's own data repository.`,
};

export default function AboutPage() {
  return (
    <div className="lw-card mt-8 px-8 py-10">
      <h1 className="serif-title pb-1 text-[26px]">About {SITE_NAME}</h1>
      <div className="post-body">
        <p>
          {SITE_NAME} is a reading and discussion community maintained by{" "}
          {SITE_ORG_NAME}. The reading layout follows LessWrong, but it runs on
          entirely different foundations: the AT Protocol. Where traditional
          forums keep everything in a private database, {SITE_NAME} stores
          each post, comment, vote, and reaction as a signed record in
        ...
        <p>
          ...
          (DID). Sign in with your email or any Bluesky handle; there is no
          separate password.
        </p>
        <p>

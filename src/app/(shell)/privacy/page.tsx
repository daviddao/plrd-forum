...
export const metadata = {
  title: "Privacy",
  description: `${SITE_NAME}'s privacy practices: what the index stores, what stays in your PDS, and how to have records removed.`,
};
  ...
  return (
    <div className="lw-card mt-8 px-8 py-10">
      ...
      <div className="post-body">
        <p>
          {SITE_NAME} is an index, not a host. When you write a post or comment,
        ...
        <p>
          ...
          network. To remove content from {SITE_NAME}, delete the record at the
